...
public class Test {
	...
	public static void main(String[] args) throws SQLException {
		...
		Employee newEmployee = new Employee(746);
		newEmployee.setFirstName("Jerzy");
		...
		System.out.println("Pracownik o id = " + newEmployee.getEmployeeId() + ": " + employee.getFirstName() + " "
		...
		empDAL.delEmployee(745, connection);
